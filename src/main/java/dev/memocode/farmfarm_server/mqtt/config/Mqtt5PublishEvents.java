...
public class Mqtt5PublishEvents implements Mqtt5ClientOptions.PublishEvents {
    ...
    public void onMessageReceived(Mqtt5Client client, PublishReturn publishReturn) {
        ...
        try {
            Mqtt5Message mqtt5Request = objectMapper.readValue(publishPacket.getPayload(), Mqtt5Message.class);
            ...
            for (String key : methodMap.keySet()) {
                ...
                if (uriTemplate.matches(mqtt5Request.getUri())) {
                    method = methodMap.get(key);
                    pathVariables = uriTemplate.match(mqtt5Request.getUri());
                    break;
                }
            }
            ...
            if (method != null) {
                ...
                Object[] args = prepareMethodArguments(method, mqtt5Request, pathVariables);
                method.invoke(controller, args);
            } else {
                throw new RuntimeException("존재하지 않는 요청입니다. method: %s, uri: %s"
                        .formatted(mqtt5Request.getMethod(), mqtt5Request.getUri()));
            }
